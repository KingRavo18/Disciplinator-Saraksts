...
if (!$img || !$title || !$release_date || !$author || !$rating) {
...
$sql = "INSERT INTO movies (user_id, img, title, release_date, author, rating) VALUES (?, ?, ?, ?, ?, ?)";
...
$stmt->bind_param("issssi", $user_id, $img, $title, $release_date, $author, $rating);
