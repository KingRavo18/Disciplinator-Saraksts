...
if (isset($_POST['email'])) {
    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'rkingovskis14@gmail.com';  // Replace with your Gmail address
            $mail->Password   = '#Malum&LucaLekaar18';  // Replace with your Gmail password or app password
            $mail->SMTPSecure = 'tls';
            $mail->Port       = 587;
