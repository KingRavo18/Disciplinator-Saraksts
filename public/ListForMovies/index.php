...
<html lang="lv">
    <head>
        <title><?= $_SESSION['page_language'] === 'lv' ? 'Disciplinators - Filmu/Seriālu Saraksts' : 'Disciplinators - Movie/Show List'; ?></title>
        <meta charset="UTF-8"/>
    ...
    <main>
            <div class="PageTitle">
                <h1 style="color: <?= isset($_SESSION['page_theme']) ? $_SESSION['page_theme'] : '#fff'; ?>"><?= $_SESSION['page_language'] === 'lv' ? 'FILMU/SERIĀLU SARAKSTS' : 'MOVIE/SHOW LIST'; ?></h1>
            </div>
            <?php
