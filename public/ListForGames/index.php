...
<html lang="lv">
    <head>
        <title><?= $language === 'lv' ? 'Disciplinators - Videospēļu Saraksts' : 'Disciplinators - Video Game List'; ?></title>
        <meta charset="UTF-8"/>
    ...
    <body>
        <main>
            ...
            <div class="pageTitle">
                <h1 style="color: <?= isset($_SESSION['page_theme']) ? $_SESSION['page_theme'] : '#fff'; ?>"><?= $language === 'lv' ? 'VIDEOSPĒĻU SARAKSTS' : 'VIDEOGAME LIST'; ?></h1>
            </div>
            <?php
    ...
    sortSelect.addEventListener("change", function () {
        sortGameList(sortSelect.value);
    });

    function sortGameList(criteria) {
