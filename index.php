...
<html lang="lv">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="public/Images/fistLogoCut.png" media="(prefers-color-scheme: light)">
        <link rel="icon" type="image/x-icon" href="public/Images/fistLogoCutDarkMode.png" media="(prefers-color-scheme: dark)">
    ...
    <body>
        <main>
            <?php 
                require "public/Registration/featureSidebar.php"; 
                require "public/Registration/terms&conditions.php"; 
            ?> 
            ...
            <div class="inputWindows">
                ...
                <div class="registration">
                    ...
                    <form action="public/Registration/login.php" method="POST">
                ...
                <div class="registration registration2">
                    <div class="registrationTitle"><h2>REĢISTRĒTIES</h2></div>
                        <form action="public/Registration/signup.php" method="POST">
                        <div class="registrationInput">
                            <input type="text" placeholder=" Lietotājvārds" name="username" title="Ievadiet lietotājvārdu" required>
            ...
            <script src="public/Registration/registration.js"></script>
        </main>
    </body>
</html>